...
class CreateUserDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, description: "@description: \"este es el nombre del usuario\"\n@example: \"esteban\"", minLength: 3, maxLength: 80 }, email: { required: true, type: () => String }, password: { required: true, type: () => String, minLength: 8, maxLength: 15 }, confirmPassword: { required: true, type: () => String }, phone: { required: true, type: () => Number }, country: { required: true, type: () => String, minLength: 5, maxLength: 20 }, address: { required: true, type: () => String }, city: { required: true, type: () => String, minLength: 5, maxLength: 20 }, isAdmin: { required: true, type: () => Boolean } };
    }
}
